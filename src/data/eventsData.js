const eventsData = [
  {
    ...
    location: "City Park",
    description:
      "Experience a vibrant evening of live music with top local bands and international headliners. Enjoy food stalls, merchandise booths, and interactive art installations. Bring your friends and family for a night of fun under the stars. Don’t miss the chance to discover new artists and genres!",
  ...
  },
  {
    ...
    description:
      "Dive into the world of modern art at our interactive exhibition. Featuring contemporary works, live artist demonstrations, and hands-on art stations for all ages. Engage with both emerging and established artists in a creative space. Participate in workshops that allow you to express your creativity.",
    image: "./interactiveArtExhibition.jpg",
  },
  {
    id: 3,
    ...
    location: "Downtown",
    description:
      "Savor the flavors of the world at the International Food Festival. Sample a diverse array of dishes from local chefs and food vendors, participate in cooking classes, and enjoy live entertainment and culinary contests. Don’t forget to vote for your favorite dish in our popular contest!",
    image: "./internationalFood.jpg",
  },
  {
    id: 4,
    name: "Literary Book Fair",
    date: "15-11-2024",
  ...
  {
    id: 11,
    name: "Gourmet Wine & Cheese Tasting",
    date: "30-12-2024",
    location: "Vineyard",
    description:
  ...
  {
    id: 12,
    name: "Annual Photography Contest",
    date: "10-01-2025",
  ...
  {
    id: 14,
    name: "Cultural Celebration Fest",
    date: "20-01-2025",
